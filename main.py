...
def main():
    ...
    while True:
        ...
        main_menu = input("1) Sign up   2) Sign in")
        ...
        while True:
            choice = input("1) Create Account   2) Select Account  3) Sign Out\n")
            ...
            #allows users to find their account
                ...
                if account is None: #if we fail to find an account, try again
                    continue
                while True:   #sub-menu loop, stays here until user picks "5"
                    ...
                    if sub_choice == "1":
                        ...
                        print(f"Bank: {my_bank.name}")
                        print(f"Branch: {my_bank.branch} ")
                        print(f"Location: {my_bank.location}")
